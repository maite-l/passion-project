...
void main() {
    ...
    float aberration = random(floor(u_time)+abs(atan(u_time)*0.001)) * 0.0015;
    color.r = texture(u_texture, v_texCoord + vec2(aberration, -aberration)).r;
    color.b = texture(u_texture, v_texCoord - vec2(aberration, -aberration)).b;
