...
float circle(vec2 _st, float _radius){
    return smoothstep(1.0-_radius,1.0-_radius+_radius*0.2,1.-dot(_st,_st)*3.14);
}
...
void main() {
    ...
    st -= 0.5;
    float d = length(st) - 0.35;
    vec3 color = vec3(circle(st, d));

    color += clamp(vec3(0.001/d), 0., 1.) * 15.;
